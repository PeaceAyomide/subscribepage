  ...
  return (
    <div className='flex flex-col pb-[10rem]'>
        ...
        <div className='flex justify-center items-start flex-row side-phone:flex-col mt-[2rem] space-x-8 side-phone:space-x-0 side-phone:space-y-8 px-[16rem] IPad:px-[7rem] side-phone:px-[4rem] phone:px-[2rem]'>
            ...
            <p className='text-[2rem] font-bold flex flex-wrap text-[#F6B25F] IPad:text-[1.2rem] side-phone:text-[1rem] phone:text-[0.8rem] side-phone:justify-center font-calibril'><span className='font-blacksword '>Launch</span> of GETMEDCO's VIP Concierge Clinic</p>
        ...
        <p className='text-[1.3rem] mt-2 IPad:text-[1rem] side-phone:text-[0.8rem] phone:text-[0.6rem] font-calibril'>
        <span className='font-blacksword text-[#F6B25F]'>Address:</span> Block 8, Plot 6A Wumego Crescent off Admiralty Road, off Christ Avenue, Lekki Phase 1, Lagos <br /> Gooogle map :
